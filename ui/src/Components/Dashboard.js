...
function Uptime() {
  ...
  if (time.days) {
    days = (
      <span>
        {time.days}
        {' '}
        <span className="dashboard-days"> Days </span>
      </span>
    );
  }
  ...
  if (time.hours) {
    hours = (
      <span>
        {time.hours}
        {' '}
        <span className="dashboard-days"> Hours </span>
      </span>
    );
  }
  ...
  if (time.minutes) {
    minutes = (
      <span>
        {time.minutes}
        {' '}
        <span className="dashboard-days"> Minutes </span>
      </span>
    );
  }
  ...
  const seconds = (
    <span>
      {time.seconds}
      {' '}
      <span className="dashboard-days"> Seconds </span>
    </span>
  );
...
function CpuUsage() {
  const [cpuStates, updateCpuStates] = useReducer((state, newState) => ({
    ...
    old: {},
    new: {
      user: 0, nice: 0, sys: 0, spin: 0, interrupt: 0, idle: 0,
    },
  });
