...
func main() {
	...
	r.HandleFunc("/api/rc/{service}/started", rcServiceStartedHandler).Methods("GET")
	r.HandleFunc("/api/rc/{service}/started", rcSetServiceStartedHandler).Methods("POST")
	r.HandleFunc("/api/rc/{service}/enabled", rcServiceEnabledHandler)
